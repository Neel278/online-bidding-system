	...
	<div id="container">
		<div id="bgwrap">
			...
			<center><h1><br />Welcome Administrator</h1></center>
				...
				<?php $adm2->notifications(); ?>
				<!--end query-->
				
					<!--for notifications-->
					<ul><div id="number"><a href="viewnotif.php" rel="facebox"><img src="./icons/26.png" alt = "0" width='74' height='72'/></a><br />Notifications<div id="num_result"><?= $_SESSION['count']; ?></div></div></ul>
					<!--end for notifications-->
					<?php $adm2->notifications2(); ?>
					<!--for notifications-->
					<ul><div id="numberee"><a href="viewended.php" rel="facebox"><img src="./icons/77.png" alt = "0" width='74' height='72'/></a><br />Ended<br /> Products<div id="end_result"><?= $_SESSION['counters']; ?></div></div></ul>
					<!--end for notifications-->
