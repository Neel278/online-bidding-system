...
<body>
	<div id="container">
        ...
        <thead>
                <tr>
                        <th sort="index">Item Name</th>
                        <th sort="description">Date Posted</th>
						<th sort="description">Date Ended</th>
						<th sort="description">Number of Bidders</th>
                        <th sort="description">Remove Notice</th>
                </tr>
        </thead>
        <tbody>
        	<?php
