...
<body>
	<div id="container">
		<?php $obj8->bidlog(); ?>
		<center><h5><?= $_SESSION['pname']['prodname']; ?> Bidding Log</h5></center>
                           <div id="bodycon">
                          <table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="700">
        <thead>
                <tr>
                    <th sort="index" align="center">Bidder</th>
                    <th sort="date" align="center">Date of Bid Placed</th>
                    <th sort="description" align="center">Amount</th>
               	</tr>
        </thead>
        <tbody>
      	<?php $obj8->bidlog2(); ?>
